...
/***/ function(module, exports, __webpack_require__) {
	...
	var Sprite = function (_EventEmitter) {
	  _inherits(Sprite, _EventEmitter);
	  ...
	  function Sprite() {
	    ...
	    _this.$dom = (0, _jquery2.default)(_this.DOM);
	    _this.$dom[0].dataset.id = _this.id;
	    _this.$dom[0].dataset.type = _this.constructor.name;
	    _this.css({
	      position: 'absolute'
	    }).moveTo(x, y);
	    return _this;
	  ...
	  _createClass(Sprite, [{
	    ...
	    value: function css() {
	      ...
	      (_$dom = this.$dom).css.apply(_$dom, arguments);
	      return this;
	    }
	  }, {
	    key: 'move',
	    value: function move(offsetX, offsetY, offsetTotate) {
	    ...
	    value: function moveTo(x, y) {
	      var rotate = arguments.length <= 2 || arguments[2] === undefined ? 0 : arguments[2];
	    ...
	    key: 'axisCenter',
	    value: function axisCenter() {
	      this.transform('translate', '-50%, -50%').css('transformOrigin', '0 0 0');
	      return this;
	    }
	  }, {
	    key: 'text',
	    ...
	    value: function animate() {
	      ...
	      (_$dom2 = this.$dom).animate.apply(_$dom2, arguments);
	      return this;
	    }
	  }, {
	    key: 'transform',
	...
	var PlanetSprite = exports.PlanetSprite = function (_Sprite) {
	  _inherits(PlanetSprite, _Sprite);

	  function PlanetSprite(size) {
	    ...
	    var _this2 = _possibleConstructorReturn(this, (_Object$getPrototypeO = Object.getPrototypeOf(PlanetSprite)).call.apply(_Object$getPrototypeO, [this].concat(args)));
	  ...
	  _createClass(PlanetSprite, [{
	    key: 'render',
	    value: function render() {
	      _get(Object.getPrototypeOf(PlanetSprite.prototype), 'render', this).call(this).size(this._size, this._size).css({
	...
	var SpaceplaneSprite = exports.SpaceplaneSprite = function (_Sprite2) {
	  _inherits(SpaceplaneSprite, _Sprite2);

	  function SpaceplaneSprite(name) {
	    var _Object$getPrototypeO2;

	    _classCallCheck(this, SpaceplaneSprite);

	    for (var _len2 = arguments.length, args = Array(_len2 > 1 ? _len2 - 1 : 0), _key2 = 1; _key2 < _len2; _key2++) {
	      args[_key2 - 1] = arguments[_key2];
	    }

	    var _this3 = _possibleConstructorReturn(this, (_Object$getPrototypeO2 = Object.getPrototypeOf(SpaceplaneSprite)).call.apply(_Object$getPrototypeO2, [this].concat(args)));
	  ...
	  _createClass(SpaceplaneSprite, [{
	    ...
	    value: function render() {
	      ...
	      }).axisCenter().transform('rotate', this.rotate + 'turn');

	      // 飞船提示
	      this.hint = new Sprite().css({
	        width: '100%',
	        height: '100%',
...
/***/ function(module, exports, __webpack_require__) {
	...
	var EventEmitter = exports.EventEmitter = function (_EventEmitter) {
	  ...
	  _createClass(EventEmitter, [{
	    ...
	    value: function on(events) {
	      ...
	      if ((typeof events === 'undefined' ? 'undefined' : _typeof(events)) === 'object' && 'length' in events) {
	        events.forEach(function (it) {
	          var _get2;

	          (_get2 = _get(Object.getPrototypeOf(EventEmitter.prototype), 'on', _this2)).call.apply(_get2, [_this2, it].concat(args));
	        });
	      } else {
	        var _get3;

	        (_get3 = _get(Object.getPrototypeOf(EventEmitter.prototype), 'on', this)).call.apply(_get3, [this, events].concat(args));
	      }
	      return this;
	    }
	  }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.BUS = exports.Mediator = exports.Medium = undefined;
	...
	var Medium = exports.Medium = function () {
	  function Medium() {
	  ...
	  _createClass(Medium, [{
	    ...
	    value: function send(msg) {
	      ...
	      setTimeout(function () {
	        if (!_this.lost()) {
	          _this.accepters.forEach(function (accepter) {
	            accepter.emit(msg);
	          });
	          d.resolve();
	        } else {
	    ...
	    key: 'add',
	    value: function add(accepter) {
	      this.accepters.push(accepter);
	    }
	  }, {
	    key: 'remove',
	    value: function remove(accepter) {
	...
	var Mediator = exports.Mediator = function (_Medium) {
	  _inherits(Mediator, _Medium);
	  ...
	  function Mediator() {
	    ...
	    return _ret = (_temp = (_this2 = _possibleConstructorReturn(this, (_Object$getPrototypeO = Object.getPrototypeOf(Mediator)).call.apply(_Object$getPrototypeO, [this].concat(args))), _this2), _this2.sendTime = 1000, _temp), _possibleConstructorReturn(_this2, _ret);
	  }

	  _createClass(Mediator, [{
	    key: 'lost',
	    value: function lost() {
	      return (0, _utils.random)(1, 100) < 0.3 * 100;
	    }
	  }]);
	...
	var BUS = exports.BUS = function (_Medium2) {
	  _inherits(BUS, _Medium2);
	  ...
	  function BUS() {
	    ...
	    return _ret2 = (_temp2 = (_this3 = _possibleConstructorReturn(this, (_Object$getPrototypeO2 = Object.getPrototypeOf(BUS)).call.apply(_Object$getPrototypeO2, [this].concat(args))), _this3), _this3.sendTime = 300, _temp2), _possibleConstructorReturn(_this3, _ret2);
	  }
	  ...
	  _createClass(BUS, [{
	    ...
	    key: 'lost',
	    value: function lost() {
	      return (0, _utils.random)(1, 100) < 0.1 * 100;
	    }
	  }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.senderAdapter = senderAdapter;
	exports.acceptAdapter = acceptAdapter;
	...
	var Sender = exports.Sender = function () {
	  function Sender(medium) {
	...
	var Accepter = exports.Accepter = function () {
	  function Accepter(medium) {
	...
	function senderAdapter(sender) {
	  ...
	  sender.send = function (msg) {
	    ...
	    // 自动重传
	    var trySend = function trySend() {
	      send(msgInt).then(function () {
	        (0, _utils.log)('发送成功', msgInt, 'green');
	      }, function () {
	        (0, _utils.log)('重传', msgInt, 'red');
	        trySend();
	      });
	    };
	    trySend();
